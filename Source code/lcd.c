...
static void lcd_write(uint8_t data,uint8_t rs) 
{
    ...
    {
        /* configure data pins as output */
        PORTK.DIR |= _BV(LCD_DATA0_PIN);
        PORTK.DIR |= _BV(LCD_DATA1_PIN);
        PORTK.DIR |= _BV(LCD_DATA2_PIN);
        PORTK.DIR |= _BV(LCD_DATA3_PIN);
...
void lcd_init(uint8_t dispAttr)
{
           ...
           && (LCD_DATA0_PIN == 0 ) && (LCD_DATA1_PIN == 1) && (LCD_DATA2_PIN == 2) && (LCD_DATA3_PIN == 3) )
    {
        ...
        PORTK.DIR |= 0x0F;
        PORTK.DIR    |= _BV(LCD_RS_PIN);

        PORTK.DIR     |= _BV(LCD_E_PIN);
    }
    else
    {
